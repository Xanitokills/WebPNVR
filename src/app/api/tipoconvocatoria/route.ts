...
export async function GET() {
  ...
  try {
    ...
    const resultado = await pool
      .request()
      .query("SELECT id_tipo,nombre, descripcion, estado FROM [PNVR].[dbo].[tipo_convocatoria]");
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await pool
      ...
      .query(
        "INSERT INTO [PNVR].[dbo].[tipo_convocatoria] (descripcion, estado) VALUES (@descripcion, @estado); SELECT SCOPE_IDENTITY() as id_tipo"
      );
