...
export async function GET() {
  ...
  try {
    ...
    const resultado = await pool
      .request()
      .query("SELECT id_tipo_material, descripcion,estado FROM [PNVR].[dbo].[Tipo_Material]");
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await pool
      ...
      .query(
        "INSERT INTO [PNVR].[dbo].[Tipo_Material] (descripcion, estado) VALUES (@descripcion, @estado); SELECT SCOPE_IDENTITY() as id_tipo_material"
      );
